...
document.getElementById("salaryCalcForm").addEventListener("submit", function (event) {
  ...
  if (matchingData) {
    ...
    document.getElementById("result").innerHTML =
      `<div style="line-height: 1.4;"><p>ไม่พบข้อมูลการปรับอัตราเงินเดือนที่สอดคล้องกับวุฒิการศึกษาและอัตราเงินเดือนตามที่ท่านระบุ กรุณาตรวจสอบข้อมูลวุฒิการศึกษาและอัตราเงินเดือนปัจจุบันของท่านอีกครั้ง </p><p>หากมีข้อสงสัยหรือต้องการข้อมูลเพิ่มเติม สามารถติดต่อสอบถามได้ที่หมายเลขโทรศัพท์ 0 2141 5192</p></div>`;
  }
});
